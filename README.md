...
aDta (170 MB): http://alaska.epfl.ch/~dockermoocs/bigdata/stackoverflow.csv
place it in the folder: src/main/resources/stackoverflow in your project directory.
